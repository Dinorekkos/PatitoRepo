...
{
    public class EnemySpawner_Mosquitoes : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            foreach (EnemySpawnpoint_Mosquitoes spawnPoint in _spawnPoints)
            {
        ...
        private void SpawnEnemy(EnemySpawnpoint_Mosquitoes spawnPoint)
        {
            ...
            EnemyController_Mosquitoes enemyController = spawned.GetComponent<EnemyController_Mosquitoes>();
        ...
        private void OnSpawnPointStateChange(EnemySpawnpoint_Mosquitoes spawnPoint)
        {
        ...
        [SerializeField]
        private List<EnemySpawnpoint_Mosquitoes> _spawnPoints = new List<EnemySpawnpoint_Mosquitoes>();
